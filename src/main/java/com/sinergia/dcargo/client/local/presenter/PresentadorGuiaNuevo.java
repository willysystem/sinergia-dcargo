...
import com.sinergia.dcargo.client.local.view.GuiaAccion;
import com.sinergia.dcargo.client.shared.dominio.Guia;

@Singleton
public class PresentadorGuiaNuevo implements Presenter {
	...
	public void go(HasWidgets container) {
		...
		display.mostrar(GuiaAccion.NUEVO, null);		
